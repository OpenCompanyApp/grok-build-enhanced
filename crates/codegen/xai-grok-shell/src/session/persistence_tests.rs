...
fn test_actor_with_syncs(
    ...
    test_actor_with_all(info, storage, remote_sync, relay_sync, false)
}
...
fn test_actor_inner(
    ...
    test_actor_with_all(info, storage, remote_sync, None, mark_summary_done)
}

fn test_actor_with_all(
    info: Info,
    storage: Arc<dyn StorageAdapter>,
    remote_sync: Option<RemoteSync>,
    relay_sync: Option<crate::relay::RelaySync>,
