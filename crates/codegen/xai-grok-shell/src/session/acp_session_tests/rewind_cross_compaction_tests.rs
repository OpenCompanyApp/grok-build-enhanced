...
async fn run_rewind_scenario() {
    ...
    write_compacted_session_fixture(&session_dir, "00000000-0000-4000-8000-000000000005");
...
async fn run_clears_marker_scenario() {
    ...
    let session_dir = crate::session::persistence::session_dir(&actor.session_info);
    write_compacted_session_fixture(&session_dir, "00000000-0000-4000-8000-000000000006");
...
async fn run_forked_rewind_scenario() {
    ...
    write_compacted_session_fixture(&source_dir, "00000000-0000-4000-8000-000000000007");
    ...
    let forked_checkpoint =
        target_dir.join("compaction_checkpoints/00000000-0000-4000-8000-000000000007.json");
