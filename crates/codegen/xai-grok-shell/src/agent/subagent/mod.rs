...
fn log_subagent_model_resolution(
    ...
    xai_grok_telemetry::unified_log::debug(
        ...
        Some(serde_json::json!({
            ...
            "child_credential_present": child_has_api_key,
            "parent_model": &parent.model,
            "parent_base_url": &parent.base_url,
            "parent_credential_present": parent_has_api_key,
        ...
        if let Some(cfg) = chat_state.get_sampling_config().await {
            ...
            xai_grok_telemetry::unified_log::debug(
                ...
                Some(serde_json::json!({
                    ...
                    "parent_credential_present": has_api_key(&inherited.api_key),
...
fn resolve_model_override_to_config(
    ...
    xai_grok_telemetry::unified_log::debug(
        ...
        Some(serde_json::json!({
            ...
            "credential_present": has_api_key(&config.api_key),
...
/// cannot leave a torn metadata or output file.
