...
use xai_grok_pager::app::{
    AgentCmd, AuthProviderArg, Command, HeadlessArgs, LeaderMgmtArgs, LeaderMgmtCommand,
...
/// Tokio defaults to one worker per logical CPU. On large hosts that can
/// exhaust a cgroup thread budget at startup; the terminal client is I/O-bound.
