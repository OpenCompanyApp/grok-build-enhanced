...
impl ChatStateHandle {
    ...
    /// turn produced none (or the actor is unavailable).
    ///
    /// Unlike [`Self::get_last_assistant_text`], this query never falls back to
    /// assistant output from an earlier prompt turn.
