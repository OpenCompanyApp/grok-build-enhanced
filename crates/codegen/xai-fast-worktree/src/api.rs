...
pub(crate) fn register_worktree(
    ...
    // Use the same canonical paths as discovery rebuild and WorktreeDb::get so
    // macOS /var vs /private/var (and other symlink roots) cannot create
    // duplicate rows for one physical worktree.
