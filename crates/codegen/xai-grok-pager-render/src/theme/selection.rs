...
mod tests {
    ...
    #[test]
    fn deterministic_catalog_has_exactly_343_unique_official_warp_choices() {
        ...
        let unique = official
            ...
            .collect::<HashSet<_>>();
        assert_eq!(official.len(), 343);
        assert_eq!(unique.len(), 343, "official Warp canonicals must be unique");
    }
