...
/// Legacy wire-mode type retained for the effect runner. New user flows
/// always use `ConversationOnly`; `All` and `FilesOnly` remain readable for
/// compatibility with in-flight results from older clients.
