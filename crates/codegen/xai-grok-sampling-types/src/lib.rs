...
pub use self::kimi_code::{
    ...
    KIMI_CODE_MODEL_NAMESPACE, KIMI_CODE_MODELS_URL, KIMI_CODE_PROVIDER_NAME,
    KIMI_CODE_REQUEST_TOO_LARGE_ERROR, KIMI_CODE_SEARCH_URL, KIMI_CODE_USAGE_URL,
    is_kimi_code_request_too_large_error,
};
...
pub use self::opencode_go::{
    EXA_HOSTED_MCP_URL, OPENCODE_COMPAT_API_KEY_ENV, OPENCODE_GO_ANTHROPIC_VERSION,
    OPENCODE_GO_API_KEY_ENV, OPENCODE_GO_AUTH_SCOPE, OPENCODE_GO_BASE_URL,
    OPENCODE_GO_CHAT_COMPLETIONS_URL, OPENCODE_GO_MAX_CATALOG_BYTES,
    OPENCODE_GO_MAX_CATALOG_MODELS, OPENCODE_GO_MESSAGES_URL, OPENCODE_GO_MODEL_NAMESPACE,
    OPENCODE_GO_MODELS_URL, OPENCODE_GO_PROVIDER_NAME, OPENCODE_GO_RESPONSES_URL,
};
