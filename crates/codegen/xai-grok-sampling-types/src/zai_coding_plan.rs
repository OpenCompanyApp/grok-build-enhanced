...
pub const ZAI_CODING_PLAN_MODELS_URL: &str = "https://api.z.ai/api/coding/paas/v4/models";

pub const ZAI_CODING_PLAN_QUOTA_URL: &str = "https://api.z.ai/api/monitor/usage/quota/limit";
pub const ZAI_CODING_PLAN_MODEL_USAGE_URL: &str = "https://api.z.ai/api/monitor/usage/model-usage";
pub const ZAI_CODING_PLAN_TOOL_USAGE_URL: &str = "https://api.z.ai/api/monitor/usage/tool-usage";

pub const ZAI_CODING_PLAN_SEARCH_MCP_URL: &str = "https://api.z.ai/api/mcp/web_search_prime/mcp";
pub const ZAI_CODING_PLAN_READER_MCP_URL: &str = "https://api.z.ai/api/mcp/web_reader/mcp";
