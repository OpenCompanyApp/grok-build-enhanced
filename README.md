...
| Enhanced release artifacts | Fork-owned stable `v0.3.11` release for macOS/Linux, with SHA-256 checksums and GitHub artifact attestations |
...
```sh
gh attestation verify "$HOME/.grok/downloads/grok-0.3.11-macos-aarch64" \
